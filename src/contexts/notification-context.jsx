...
//   // Função para adicionar notificação local (para testes ou notificações instantâneas)
//   const addNotification = (notification) => {
//     const id = Date.now()
//     const newNotification = {
//       id,
//       message: notification.message,
//       action: notification.action || "bell",
//       time: "Agora mesmo",
//       timestamp: new Date(),
//       read: false,
...
//       // Fazer chamada para API se houver endpoint para limpar
//       // const response = await fetch("https://megastage.onrender.com/api/v1/notifications/clear", {
//       //   method: "DELETE",
//       //   headers: {
//       //     Authorization: `Bearer ${token}`,
//       //     "Content-Type": "application/json",
...
//       // Por enquanto, apenas limpar localmente
//       setNotifications([])
//       setUnreadCount(0)
//       notificationsCache.current = { data: [], timestamp: 0, ttl: 5 * 60 * 1000 }
