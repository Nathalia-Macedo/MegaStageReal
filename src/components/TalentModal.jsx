              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-3/5 p-6">
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        <h3 className="text-sm uppercase tracking-wider text-gray-500 font-medium">Vídeos do Portfólio</h3>
                        {videos.length > 0 && (
                          <span className="text-xs text-gray-400">
                          ...
                          {videos.filter(video => video && video.id != null).map((video, index) => (
                            ...
                            >
                              <video
                                ...
                                controls
                              >
                                <source src={video.video_url || "/placeholder-video.mp4"} type="video/mp4" />
