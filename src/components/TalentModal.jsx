...
//   const { selectedTalent, isModalOpen, closeModal, toggleHighlight, openEditModal, fetchTalentPhotos, fetchPreviousJobs } = useTalent()
...
//   // Carregar fotos e trabalhos automaticamente quando o modal abrir
//   useEffect(() => {
...
//       console.log("Condição atendida, chamando loadPhotos e loadJobs")
//       loadPhotos()
//       loadJobs()
//     } else {
...
//     setLoadingJobs(true)
//     try {
//       const jobsData = await fetchPreviousJobs(selectedTalent.id) // Corrigido para fetchPreviousJobs
//       console.log("Resposta de fetchPreviousJobs (crua):", jobsData)
//       // Tentativa inicial simples de obter um array de jobs
...
//                 {/* Coluna da foto e habilidades/idiomas */}
//                 <div className="w-full md:w-2/5 relative bg-gray-50">
//                   <div className="relative aspect-[3/4] h-96 md:h-120 w-full">
//                     <img
...
//                     />
//                     {/* Status indicator */}
//                     <div className="absolute top-2 left-2 flex items-center space-x-1.5 bg-white/90 p-1 rounded-full shadow-sm">
...
//                     )}
//                   </div>
//                   {/* Habilidades e Idiomas abaixo da foto */}
...
//                         {jobs.length > 0 && (
//                           <span className="text-xs text-gray-400">
//                             {jobs.length} trabalho{jobs.length !== 1 ? "s" : ""}
//                           </span>
//                         )}
//                       </div>
//                       {loadingJobs ? (
...
//                           <p className="text-sm text-gray-500">Nenhum trabalho cadastrado</p>
//                         </div>
//                       ) : (
