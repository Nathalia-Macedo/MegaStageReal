...
// import { Settings, HelpCircle, User, Bell, Shield, Layout, Database, Users, ChevronRight, Moon, Sun, Globe, LogOut } from 'lucide-react'
...
//     { id: "appearance", label: "Aparência", icon: <Layout size={20} /> },
...
//             <h2 className="text-2xl font-bold text-gray-800 mb-4">Ajuda - Talentos</h2>
//             <p className="text-gray-600">Conteúdo de ajuda para a seção de talentos será exibido aqui.</p>
//           </div>
//         )
//       case "highlights":
//         return (
...
//         return (
//           <div className="bg-white rounded-lg shadow-sm p-6">
//             <h2 className="text-2xl font-bold text-gray-800 mb-4">Ajuda - Usuários</h2>
//             <p className="text-gray-600">Conteúdo de ajuda para a seção de usuários será exibido aqui.</p>
//           </div>
//         )
//       case "notifications":
//         return (
...
//         return (
//           <div className="bg-white rounded-lg shadow-sm p-6">
//             <h2 className="text-2xl font-bold text-gray-800 mb-4">Configurações de {tabs.find(t => t.id === activeTab)?.label}</h2>
