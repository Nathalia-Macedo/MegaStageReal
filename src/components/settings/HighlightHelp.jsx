...
//       description: "Veja todos os detalhes de um talento destacado.",
//       items: [
//         {
//           id: "view-details",
//           title: "Detalhes do Talento",
//           icon: <Info className="w-5 h-5 text-blue-500" />,
//           description: "Confira nome, idade, altura e mais.",
...
//           description: "Veja as fotos do portfólio.",
...
//           description: "Assista aos vídeos do talento.",
...
//       description: "Edite as informações de um talento destacado.",
//       items: [
//         {
//           id: "edit-basics",
//           title: "Editar Informações",
//           icon: <User className="w-5 h-5 text-blue-500" />,
//           description: "Mude nome, idade, altura e outros dados.",
//           tip: "Clique em 'Editar Perfil' no modal de visualização.",
//           color: "border-blue-200",
//           iconBg: "bg-blue-100",
//           iconColor: "text-blue-500",
//         },
...
//           icon: <ImageIcon className="w-5 h-5 text-green-500" />,
//           description: "Envie novas fotos ou vídeos.",
...
//           description: "Guarde as mudanças feitas.",
