...
//   // Efeito para garantir que o scroll esteja no topo quando o passo mudar
//   useEffect(() => {
//     if (contentRef.current) {
//       contentRef.current.scrollTop = 0
//     }

//     // Desativa o estado de mudança de passo após a renderização
...
//     if (!formData.cover) newErrors.cover = "Foto é obrigatória"
...
//       }
//       if (!formData.cover) {
//         setErrors((prev) => ({ ...prev, cover: "Foto é obrigatória" }))
//         setTouched((prev) => ({ ...prev, cover: true }))
//         isValid = false
//       }
...
//     if (activeStep < 3) {
//       // Ativa o estado de mudança de passo
...
//       // Muda o passo após garantir que o scroll está no topo
...
//                 scrollBehavior: "auto", // Garante que o scroll seja instantâneo
//               }}
//             >
...
//                               Foto do Talento <span className="text-pink-500">*</span>
//                             </label>
//                             <div
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-2 sm:p-4 overflow-y-auto backdrop-blur-sm"
          onClick={onClose}
        >
          <motion.div
            ref={modalRef}
            ...
            exit={{ opacity: 0, y: 20 }}
            transition={{ type: "spring", damping: 25 }}
            className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-5xl transform relative overflow-hidden"
            style={{ maxHeight: "95vh" }}
          >
            ...
            <div className="bg-gradient-to-r from-pink-500 to-purple-600 px-6 py-5 relative">
              ...
              <div className="flex justify-between items-center relative z-10">
                <div>
                  <h2 className="text-2xl font-bold text-white">Adicionar Novo Talento</h2>
                  <div className="flex items-center mt-2">
                    ...
                    <span className="text-white/80 text-sm ml-4">Passo {activeStep} de 3</span>
                  </div>
                </div>
                <button
                  onClick={(e) => {
                  ...
                  className="bg-white/20 text-white rounded-full p-2 hover:bg-white/30 transition-colors backdrop-blur-sm"
                  aria-label="Fechar"
                  type="button"
                >
                  <X className="h-5 w-5" />
            ...
            <div
              ref={contentRef}
              className="overflow-y-auto dark:bg-gray-900 dark:text-gray-100"
              style={{
                ...
                <AnimatePresence mode="wait">
                  {activeStep === 1 && (
                    ...
                    >
                      <div className="flex items-center mb-6">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Informações Básicas</h3>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                          <div className="mb-6">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Foto do Talento <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <motion.div
                              className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all ${
                                errors.cover
                                  ? "border-red-300 dark:border-red-500/50 bg-red-50 dark:bg-red-900/10"
                                  : "border-gray-300 dark:border-gray-700 hover:border-pink-300 dark:hover:border-pink-700 hover:bg-pink-50 dark:hover:bg-pink-900/10"
                              } group relative overflow-hidden`}
                              onClick={triggerFileInput}
                              onDragOver={handleDragOver}
                              onDrop={handleDrop}
                            ...
                            >
                              {imagePreview ? (
                                <div className="relative">
                                  ...
                                  />
                                  <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg">
                                    <div className="bg-white dark:bg-gray-800 bg-opacity-90 dark:bg-opacity-90 px-3 py-2 rounded-lg shadow-lg">
                                      <Camera className="h-5 w-5 text-pink-500 dark:text-pink-400 inline-block mr-1" />
                                ...
                                <div className="py-10 px-4">
                                  <div className="bg-gradient-to-br from-pink-500 to-purple-600 rounded-full p-4 w-20 h-20 mx-auto mb-4 flex items-center justify-center shadow-lg">
                                    <Camera className="h-10 w-10 text-white" />
                                  </div>
                                  <p className="text-gray-700 dark:text-gray-200 font-medium mb-2">
                                    Arraste e solte uma foto aqui
                                  </p>
                                  <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">ou</p>
                                  <motion.button
                                    type="button"
                                    className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg hover:from-pink-600 hover:to-purple-700 transition-colors shadow-sm"
                            ...
                            {errors.cover && (
                              <motion.p
                                initial={{ opacity: 0, y: -10 }}
                                animate={{ opacity: 1, y: 0 }}
                                className="text-red-500 dark:text-red-400 text-xs mt-2 flex items-center"
                              >
                                <AlertCircle className="h-3 w-3 mr-1" />
                                {errors.cover}
                              </motion.p>
                        ...
                        <div>
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Nome Completo <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <input
                              type="text"
                              name="name"
                              ...
                              onChange={handleChange}
                              onBlur={handleBlur}
                              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 transition-all dark:bg-gray-800 dark:text-white ${
                                errors.name && touched.name
                                  ? "border-red-300 dark:border-red-500/50 bg-red-50 dark:bg-red-900/10"
                          ...
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Tipo do Talento <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <div className="grid grid-cols-2 gap-3">
                              <motion.label
                                className={`
                                ...
                                ${
                                  formData.type === "Ator"
                                    ? "border-pink-500 dark:border-pink-400 bg-pink-50 dark:bg-pink-900/20 text-pink-700 dark:text-pink-300"
                                    : "border-gray-200 dark:border-gray-700 hover:border-pink-300 dark:hover:border-pink-700 text-gray-700 dark:text-gray-300"
                                }
                              `}
                                whileHover={{ y: -2 }}
                                whileTap={{ scale: 0.98 }}
                          ...
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Data de Nascimento <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <div className="relative">
                              <input
                                type="date"
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 text-gray-700 dark:text-white dark:bg-gray-800 ${
                                  errors.birth_date && touched.birth_date
                                    ? "border-red-300 dark:border-red-500/50 bg-red-50 dark:bg-red-900/10"
                                    : "border-gray-300 dark:border-gray-700"
                                }`}
                              />
                              <Calendar className="absolute right-3 top-3 h-5 w-5 text-gray-400 dark:text-gray-500 pointer-events-none" />
                            </div>
                            {errors.birth_date && touched.birth_date && (
                              <motion.p
                                initial={{ opacity: 0, y: -10 }}
                          ...
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">Instagram</label>
                            <div className="relative">
                              <input
                                type="text"
                                name="instagram"
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                className={`w-full px-4 py-3 pl-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 dark:bg-gray-800 dark:text-white ${
                                  errors.instagram && touched.instagram
                                    ? "border-red-300 dark:border-red-500/50 bg-red-50 dark:bg-red-900/10"
                                    : "border-gray-300 dark:border-gray-700"
                                }`}
                                placeholder="@usuario"
                              />
                              <Instagram className="absolute left-3 top-3 h-5 w-5 text-gray-400 dark:text-gray-500" />
                            </div>
                            {errors.instagram && touched.instagram ? (
                              <motion.p
                                initial={{ opacity: 0, y: -10 }}
                              ...
                              <p className="text-gray-500 dark:text-gray-400 text-xs mt-2">Exemplo: @usuario</p>
                            )}
                          </div>
                        </div>
                      </div>
                  ...
                  {activeStep === 2 && (
                    ...
                    >
                      <div className="flex items-center mb-6">
                        <div className="bg-pink-100 dark:bg-pink-900/30 p-2 rounded-full mr-3">
                          <Ruler className="h-5 w-5 text-pink-500 dark:text-pink-400" />
                        </div>
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Características Físicas</h3>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Altura (cm) <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <div className="relative">
                              <input
                                type="number"
                                ...
                                max="250"
                              />
                              <span className="absolute right-3 top-3 text-gray-400 dark:text-gray-500">cm</span>
                            </div>
                            {errors.height && touched.height && (
                              <motion.p
                                initial={{ opacity: 0, y: -10 }}
                          ...
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Cor dos Olhos <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <div className="relative">
                              <select
                                name="eye_color"
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 text-gray-700 dark:text-white dark:bg-gray-800 appearance-none ${
                                  errors.eye_color && touched.eye_color
                                    ? "border-red-300 dark:border-red-500/50 bg-red-50 dark:bg-red-900/10"
                                    : "border-gray-300 dark:border-gray-700"
                                }`}
                              >
                                ...
                                {eyeColorOptions.map((color) => (
                                  <option key={color} value={color} className="text-gray-700 dark:text-white">
                                    {color}
                                  </option>
                                ))}
                              </select>
                        ...
                        <div>
                          <div className="mb-5">
                            <label className="block text-gray-700 dark:text-gray-200 font-medium mb-2">
                              Cor do Cabelo <span className="text-pink-500 dark:text-pink-400">*</span>
                            </label>
                            <div className="relative">
                              <select
                                name="hair_color"
                          ...
                          <div className="mb-5">
                            ...
                            <motion.div
                              ...
                              whileHover={{ y: -2 }}
                            >
                              <label className="flex items-center text-gray-700 dark:text-gray-200 mb-4">
                                <input
                                  type="checkbox"
                                  name="can_sing"
                                  checked={formData.can_sing}
                              ...
                              <div className="mb-3">
                                ...
                                <div className="flex">
                                  <input
                                    ...
                                    value={newInstrument}
                                    onChange={(e) => setNewInstrument(e.target.value)}
                                    className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 text-gray-700 dark:text-white dark:bg-gray-800"
                                    placeholder="Adicionar instrumento"
                                    onKeyPress={(e) => e.key === "Enter" && (e.preventDefault(), addInstrument())}
                                  />
                                  <motion.button
                                    type="button"
                                    onClick={addInstrument}
                                    className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-r-lg hover:from-pink-600 hover:to-purple-700 transition-colors flex items-center justify-center"
                                ...
                                {formData.instruments.length > 0 ? (
                                  formData.instruments.map((instrument, index) => (
                                    <motion.div
                                      ...
                                      initial={{ opacity: 0, scale: 0.8 }}
                                      animate={{ opacity: 1, scale: 1 }}
                                      className="bg-white dark:bg-gray-700 px-3 py-1 rounded-full flex items-center border border-gray-200 dark:border-gray-600 shadow-sm"
                                    >
                                      <Music className="h-3 w-3 text-pink-500 dark:text-pink-400 mr-1" />
                                      <span className="text-sm text-gray-700 dark:text-gray-200">{instrument}</span>
                                      <button
                                        type="button"
                                        onClick={() => removeInstrument(index)}
                                        className="ml-1 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 p-1"
                                      >
                                        <X className="h-3 w-3" />
                                      </button>
                                    </motion.div>
                    ...
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                          <div className="flex items-center mb-6">
                            <div className="bg-pink-100 dark:bg-pink-900/30 p-2 rounded-full mr-3">
                              <Globe className="h-5 w-5 text-pink-500 dark:text-pink-400" />
                            </div>
                            <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Idiomas</h3>
                          </div>
                          ...
                          <div className="mb-5">
                            <div className="flex">
                              <input
                                ...
                                value={newLanguage}
                                onChange={(e) => setNewLanguage(e.target.value)}
                                className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 text-gray-700 dark:text-white dark:bg-gray-800"
                                placeholder="Adicionar idioma"
                                onKeyPress={(e) => e.key === "Enter" && (e.preventDefault(), addLanguage())}
                              />
                              <motion.button
                                type="button"
                                onClick={addLanguage}
                                className="px-4 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-r-lg hover:from-pink-600 hover:to-purple-700 transition-colors flex items-center justify-center"
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                              >
                                <PlusCircle className="h-4 w-4" />
                            ...
                            <motion.div
                              className="bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 p-5 mt-4 min-h-[150px]"
                              whileHover={{ y: -2 }}
                            >
                              <div className="flex flex-wrap gap-2">
                                {formData.languages.length > 0 ? (
                                  formData.languages.map((language, index) => (
                                    <motion.div
                                      ...
                                      className="bg-white dark:bg-gray-700 px-3 py-1 rounded-full flex items-center border border-gray-200 dark:border-gray-600 shadow-sm"
                                    >
                                      <Globe className="h-3 w-3 text-pink-500 dark:text-pink-400 mr-1" />
                                  ...
                                  <div className="flex flex-col items-center justify-center w-full h-full py-6">
                                    <Globe className="h-8 w-8 text-gray-300 dark:text-gray-600 mb-2" />
                                    <p className="text-gray-400 dark:text-gray-500 text-sm">Nenhum idioma adicionado</p>
                                  </div>
                                )}
                              </div>
                            </motion.div>
                        ...
                        <div>
                          <div className="flex items-center mb-6">
                            <div className="bg-pink-100 dark:bg-pink-900/30 p-2 rounded-full mr-3">
                              <Settings className="h-5 w-5 text-pink-500 dark:text-pink-400" />
                            </div>
                          ...
                          <div className="space-y-4">
                            <motion.div
                              className="p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow"
                              whileHover={{
                                y: -3,
                            ...
                            >
                              <div className="flex items-center mb-2">
                                ...
                                <label
                                  ...
                                  className="font-medium text-gray-700 dark:text-gray-200 flex items-center"
                                >
                                  Ativo
                                  <button
                                    type="button"
                                ...
                                >
                                  ...
                                  <div className="relative">
                                    <input
                                      ...
                                      onChange={handleChange}
                                      onBlur={handleBlur}
                                      className={`w-full px-4 py-2 border rounded-lg text-gray-700 dark:text-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-pink-500 dark:focus:ring-pink-400 ${
                                        errors.data_disponibilidade && touched.data_disponibilidade
                                          ? "border-red-300 dark:border-red-500/50 bg-red-50 dark:bg-red-900/10"
                                          : "border-gray-300 dark:border-gray-700"
                                      }`}
                                    />
                                    <Calendar className="absolute right-3 top-2 h-4 w-4 text-gray-400 dark:text-gray-500 pointer-events-none" />
                                  </div>
                                  {errors.data_disponibilidade && touched.data_disponibilidade && (
                                    <motion.p
                                      initial={{ opacity: 0, y: -10 }}
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
                    <div>
                      {activeStep > 1 && (
                        <motion.button
                          type="button"
                          onClick={goToPrevStep}
                          className="w-full sm:w-auto px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center justify-center"
                          disabled={isChangingStep}
                    ...
                    <div className="flex flex-col-reverse sm:flex-row gap-3">
                      <motion.button
                        ...
                        className="w-full sm:w-auto px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                        disabled={isSubmitting || isChangingStep}
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
