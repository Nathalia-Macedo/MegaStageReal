...
import { Users, Star, Bell, Calendar, TrendingUp, Activity, ChevronRight, Eye, Edit, UserPlus, Clock, RefreshCw, Filter, Trash } from 'lucide-react'
    ...
    if (!talent.ativo) {
      ...
      return (
        <span className="px-2 py-1 rounded-full text-xs bg-yellow-100 text-yellow-800">
          {talent.data_disponibilidade
            ? `Indisponível até ${new Date(talent.data_disponibilidade).toLocaleDateString("pt-BR")}`
            : "Indisponível"}
        </span>
      )
    }
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                onClick={() => console.log("Ver todos os destaques")}
                    ...
                    <div className="flex items-start p-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-2 flex items-center justify-between">
                          <div>{renderTalentStatus(talent)}</div>
                          <span className="text-xs text-gray-500">{calculateAge(talent.birth_date)} anos</span>
                        </div>
                      </div>
                    </div>
                    <div className="bg-white p-2 border-t border-gray-100 flex justify-between">
                      <button
